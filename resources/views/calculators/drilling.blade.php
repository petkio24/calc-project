...
@section('title', 'Калькулятор сверления')
...
@section('content')
    <div class="calculator-container">
        ...
        <nav class="calc-breadcrumbs">
            ...
            <span class="calc-breadcrumbs__item active">Калькулятор сверления</span>
        </nav>

        <!-- Заголовок -->
        <div class="calc-header">
            <h1>Расчет режимов сверления</h1>
            <h2>Оптимальные параметры обработки</h2>
        </div>
            ...
            <div class="calc-grid">
                ...
                <div class="calc-section">
                    ...
                    <div class="calc-input-group">
                        <label class="calc-input-group__label" for="calc_diameter">Диаметр сверла (мм)</label>
        ...
        @if(isset($result))
            <div class="calc-results">
                <div class="results-header">
                    ...
                    <div class="results-subtitle">Оптимальные режимы обработки</div>
                </div>
